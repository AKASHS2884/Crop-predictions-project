...
const crops = ["Rice", "Maize", "Sugarcane", "Cotton", "Groundnut", "Banana", "Coconut", "Ragi", "Chilli", "Turmeric"];
...
export default function Predict({ t }) {
  ...
  const chartData = result
    ? [...historical, { name: "Pred", value: result.predicted_yield_tph }]
    : historical;
